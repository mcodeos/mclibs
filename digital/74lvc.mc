...
component LVC.74LVC10
{
    pins = [
        ...
        10 = C3, "Input C3", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
...
component LVC.74LVC20
{
    pins = [
        ...
        6 = GND, "Ground"
        7 = Y2, "Output Y2", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        8 = D2, "Input D2", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        9 = C2, "Input C2", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        10 = B2, "Input B2", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        11 = A2, "Input A2", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        12 = VCC, "Power supply 1.65V~5.5V"
    ]
}
...
component LVC.74LVC30
{
    pins = [
        ...
        9 = H, "Input H", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        10 = VCC, "Power supply 1.65V~5.5V"
    ]
}
...
component LVC.74LVC42
{
    pins = [
        ...
        15 = D, "Input D (MSB)", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        16 = VCC, "Power supply 1.65V~5.5V"
    ]
}
...
component LVC.74LVC48
{
    pins = [
        ...
        11 = f, "Segment f - active high", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        12 = e, "Segment e - active high", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        13 = d, "Segment d - active high", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        14 = c, "Segment c - active high", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        15 = b, "Segment b - active high", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        16 = a, "Segment a - active high", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
    ]
}
...
component LVC.74LVC373
{
    pins = [
        ...
        6 = D5, "Data 5", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        7 = D6, "Data 6", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        8 = D7, "Data 7", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        9 = D8, "Data 8", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        10 = GND, "Ground"
        11 = Q8, "Output Q8", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        12 = Q7, "Output Q7", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        13 = Q6, "Output Q6", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        14 = Q5, "Output Q5", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        15 = Q4, "Output Q4", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        16 = Q3, "Output Q3", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        17 = Q2, "Output Q2", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        18 = Q1, "Output Q1", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        19 = LE, "Latch enable - active high", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
...
component LVC.74LVC374
{
    pins = [
        ...
        17 = Q2, "Output Q2", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        18 = Q1, "Output Q1", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        19 = CLK, "Clock - rising edge", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        20 = VCC, "Power supply 1.65V~5.5V"
    ]
}
...
component LVC.74LVC190
{
    pins = [
        ...
        8 = GND, "Ground"
        9 = RCO, "Ripple carry output", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        10 = MAXMIN, "Max/min indicator", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
...
{
    pins = [
        1 = SER, "Serial input", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        2 = QA, "Output QA", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        3 = QB, "Output QB", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        4 = QC, "Output QC", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        5 = QD, "Output QD", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        6 = QE, "Output QE", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        7 = QF, "Output QF", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        8 = GND, "Ground"
...
component LVC.74LVC194
{
    pins = [
        ...
        7 = S1, "Mode select S1", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        8 = GND, "Ground"
        ...
        15 = DD, "Data D", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        16 = VCC, "Power supply 1.65V~5.5V"
    ]
}
...
component LVC.74LVC151
{
    pins = [
        ...
        8 = GND, "Ground"
        9 = D7, "Data 7", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        10 = Y, "Output Y", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        11 = YN, "Output Y complement", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
...
{
    pins = [
        1 = A1, "Select A1", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        2 = B1, "Select B1", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        3 = D10, "Data 10", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        4 = D11, "Data 11", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        5 = D12, "Data 12", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        6 = D13, "Data 13", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        7 = Y1, "Output Y1", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        8 = GND, "Ground"
        9 = Y2, "Output Y2", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        10 = D23, "Data 23", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        11 = D22, "Data 22", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        12 = D21, "Data 21", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        13 = D20, "Data 20", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        14 = B2, "Select B2", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        15 = A2, "Select A2", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        16 = VCC, "Power supply 1.65V~5.5V"
    ]
}
...
component LVC.74LVC245
{
    pins = [
        ...
        5 = B2, "Data B2", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        6 = A3, "Data A3", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        7 = B3, "Data B3", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        8 = A4, "Data A4", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        9 = B4, "Data B4", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        10 = GND, "Ground"
        11 = B5, "Data B5", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        12 = A5, "Data A5", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        13 = B6, "Data B6", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        14 = A6, "Data A6", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        15 = B7, "Data B7", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        16 = A7, "Data A7", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        17 = B8, "Data B8", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        18 = A8, "Data A8", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        19 = DIR, "Direction control", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        20 = VCC, "Power supply 1.65V~5.5V"
    ]
}
