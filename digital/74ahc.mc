...
{
    pins = [
        1 = CLK1A, "Clock 1A", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        2 = CLK1B, "Clock 1B", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        3 = Q0, "Output Q0", voltage:[low:0V ~ 0.05*VCC, high:0.95*VCC ~ VCC]
        4 = R01, "Reset 01", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
...
{
    pins = [
        1 = CLK1, "Clock 1", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        2 = MR1, "Master reset 1", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
...
{
    pins = [
        1 = A, "Address A", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        2 = B, "Address B", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        3 = 1D0, "Data 0 for selector 1", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
...
component AHC.74AHC245
{
    pins = [
        ...
        7 = A3, "Bus A3", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
