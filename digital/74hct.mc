...
# 74HCT Series - CMOS with TTL compatibility (4.5V~5.5V)
# Applications: TTL systems, mixed logic designs

# 74HCT00 - Quad 2-input NAND gate
component HCT.74HCT00
{
    pins = [
...
# 74HCT30 - 8-input NAND gate
component HCT.74HCT30
{
    pins = [
...
# 74HCT03 - Quad 2-input NAND gate (open collector)
component HCT.74HCT03
{
    pins = [
        1 = A1, "Input A1", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        2 = B1, "Input B1", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
...
# 74HCT42 - BCD to decimal decoder
component HCT.74HCT42
{
    pins = [
...
# 74HCT147 - 10-to-4 line priority encoder (active low)
...
# 74HCT76 - Dual JK flip-flop (negative edge triggered)
component HCT.74HCT76
{
    pins = [
...
# 74HCT174 - Hex D flip-flop (common clock/clear, 3-state)
...
# 74HCT373 - Octal D latch (3-state, transparent latch)
component HCT.74HCT373
{
    pins = [
...
# 74HCT374 - Octal D flip-flop (3-state, edge triggered)
component HCT.74HCT374
{
    pins = [
...
# 74HCT160 - Synchronous 4-bit decimal counter (synchronous clear/load)
...
# 74HCT190 - Synchronous decimal up/down counter (asynchronous load)
component HCT.74HCT190
{
    pins = [
...
# 74HCT90 - Asynchronous 2-5-10 counter
...
# 74HCT161 - Synchronous 4-bit binary counter (synchronous clear/load)
...
# 74HCT163 - Synchronous 4-bit binary counter (synchronous clear, asynchronous load)
...
# 74HCT191 - Synchronous 4-bit binary up/down counter (asynchronous load)
component HCT.74HCT191
{
    pins = [
        1 = D0, "Data 0", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
        2 = D1, "Data 1", voltage:[low:0V ~ 0.3*VCC, high:0.7*VCC ~ VCC]
...
# 74HCT393 - Dual 4-bit asynchronous binary counter
...
# 74HCT4017 - Decimal counter/decade divider
component HCT.74HCT4017
{
    pins = [
...
# 74HCT4022 - Octal counter/8-stage divider
...
# 74HCT164 - 8-bit serial-in parallel-out shift register (asynchronous clear)
component HCT.74HCT164
{
    pins = [
...
# 74HCT165 - 8-bit parallel-in serial-out shift register (parallel load)
component HCT.74HCT165
{
    pins = [
...
# 74HCT595 - 8-bit serial-in parallel-out shift register (3-state, output latch)
component HCT.74HCT595
{
    pins = [
...
# 74HCT597 - 8-bit parallel-in serial-out shift register (with latch)
...
# 74HCT194 - 4-bit bidirectional shift register (parallel load)
component HCT.74HCT194
{
    pins = [
...
# 74HCT151 - 8-to-1 data selector (complementary outputs)
component HCT.74HCT151
{
    pins = [
...
# 74HCT153 - Dual 4-to-1 data selector
component HCT.74HCT153
{
    pins = [
...
# 74HCT245 - Octal bidirectional bus transceiver (3-state)
component HCT.74HCT245
{
    pins = [
...
# 74HCT244 - Octal buffer/line driver (3-state, unidirectional)
